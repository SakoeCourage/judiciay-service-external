...
export function BlankImagePlaceholder({
  ...
  return (<div className="w-full">
    ...
    <div
      ...
      {...dragProps}
      className={` active:bg-gray-50 aspect-square mx-auto  min-h-44 min-w-44  h-full  cursor-pointer ${isDragging && "opacity-50"
        }
          ${hasFiles ? "w-full " : "w-1/2 md:w-1/3 lg:w-1/4  "}
        `}>
