...
import CompanyDetailsReview from '../../applicationreviews/companydetailsreview'
import Noticecard from '@app/app/components/ui/noticecard'

const ReviewEntityRep: StepperComponent<Partial<applicationIndividualSelfDto>> = (props) => {
    const { data } = props
    return (
...
export default ReviewEntityRep